const AlRabaaStore = (() => {
  ...
  return {
    ...
    listStoreCarts: () => api("/carts"),
    updateStoreCart: (id, input) => api(`/carts/${encodeURIComponent(id)}`, { method: "PATCH", body: input }),
    deleteStoreCart: (id) => api(`/carts/${encodeURIComponent(id)}`, { method: "DELETE" }),
